    ...
    <div class='preview-header landing-project-preview page'>
        <div class='text-pane'>
          ...
          <div class="project-icons">
            ${h.map(e=>i`<a target="_blank" href="${e}"
        ...
        <div class='code-pane'>
          <div style="padding: 22.3px 120px 45.9px 35.74px; box-sizing: border-box; height: 100%; width: 100%">
            <div style="height: 100%; width: 100%">
                <pre><code class="language-c">${g}</code></pre>
            </div>
          </div>
        </div>
    </div>
