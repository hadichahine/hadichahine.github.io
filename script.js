...
(()=>{var e={424:(e,t,n)=>{const{LitElement:r,html:i,css:o}=n(476);customElements.define("layout-central",class extends r{render(){return i` <div class="landing-page">
    ...
    ${this.data.map((({name:e,shortDescription:t,code:n,description:r,links:i})=>o`<div class="preview-header landing-project-preview page">
          <div class="text-pane">
            <div>
            ...
            <div class="project-icons">
              ${i.map((({url:e})=>o`<a target="_blank" href="${e}"
                    ><img src="${function(e){switch(new URL(e).hostname){case"github.com":return c;case"www.npmjs.com":return u;case"aur.archlinux.org":return l}}(e)}"
                  /></a>`))}
            </div>
          </div>
          <div class="code-pane">
    ...
    </div>`}static get styles(){return a`
            a {
              text-decoration: none;
            }
